...
toyFinalPrice = toy1.price + toy2.price

console.log(`El precio de los juguetes es ${toyFinalPrice}`)
...
console.log(`El precio final de ${car1.name} es ${car1.finalPrice}`)
console.log(`El precio final de ${car2.name} es ${car2.finalPrice}`)
